...
type ResType<Value extends Record<string, unknown> | Record<string, unknown>[] | undefined, T> = Promise<
	(Value extends undefined ? T : string) | undefined
>;

export const getSet =
	<T extends Record<string, unknown> | Record<string, unknown>[]>(name: string) =>
